#!/bin/bash
# Icon Generation Script for Suzy Snooze

SRC="/data/code/gt/tandroid/sel2inSnooze/iconMake/suzy_snoozy.png"
...
# Also common for launcher
convert "$SRC" -resize 48x48   "$DEST/mipmap-mdpi/ic_launcher_round.png"
convert "$SRC" -resize 72x72   "$DEST/mipmap-hdpi/ic_launcher_round.png"
convert "$SRC" -resize 96x96   "$DEST/mipmap-xhdpi/ic_launcher_round.png"
convert "$SRC" -resize 144x144 "$DEST/mipmap-xxhdpi/ic_launcher_round.png"
convert "$SRC" -resize 192x192 "$DEST/mipmap-xxxhdpi/ic_launcher_round.png"
